...
Map<CareerType, List<Career>> careers = {
  CareerType.visualComm: const [
    ...
    Career(
      ...
      overview: '''A web designer is a professional responsible for creating visually appealing and functional websites. They combine their design skills with technical knowledge to develop user-friendly websites that meet the client's requirements. Web designer’s focus on the overall look and feel of a website, including layout, color schemes, typography, and graphics.\n
